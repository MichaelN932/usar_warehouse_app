                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <button
                        ...
                        className="block mt-2 text-sm text-fire-600 hover:text-fire-700"
                      >
                        Return
                      </button>
                    </div>
        ...
        <Card title="Summary">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-sm text-gray-500">Days Since First Issue</div>
            </div>
          </div>
        </Card>
      )}
        ...
        {selectedItem && (
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-500 mt-1">Qty: {selectedItem.quantity}</p>
            </div>
