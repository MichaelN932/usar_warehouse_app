  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Record incoming inventory from purchase orders</p>
      </div>
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-sm">
                          ...
                          <span className="text-gray-400"> / {line.quantityOrdered}</span>
                        </p>
                        <p className="text-xs text-gray-500">${line.lineTotal.toFixed(2)}</p>
                      </div>
                    </div>
                  );
                })}
