  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-heading-lg text-primary-900">Request Items</h1>
          <p className="text-primary-600">Browse and request gear from the warehouse</p>
        </div>
        {cart.length > 0 && (
          <button
                    ...
                    <div
                      ...
                      className={`p-4 rounded-lg border-2 cursor-pointer transition-colors ${
                        selectedItemType?.id === itemType.id
                          ? 'border-action-primary bg-primary-50'
                          : 'border-primary-200 hover:border-primary-300'
                      }`}
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-medium text-primary-900">{itemType.name}</h4>
        ...
        <div className="space-y-4">
          <Card title="Selection">
            {!selectedItemType ? (
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-primary-900">{selectedItemType.name}</h4>
                  <p className="text-sm text-primary-500">{selectedItemType.femaCode}</p>
                </div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {availableSizes.map((size) => {
                        ...
                        return (
                          ...
                          >
                            <span>{size.name}</span>
                            <span className={`block text-xs ${stock === 0 ? 'text-red-500' : 'text-primary-500'}`}>
                              {stock} avail
                            </span>
                          </button>
                        );
