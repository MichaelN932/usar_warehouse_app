...
export function FulfillmentQueue() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-heading-lg text-primary-900">Fulfillment Queue</h1>
        <p className="text-primary-600">Process and fulfill gear requests</p>
      </div>
        ...
        {selectedRequest && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm text-primary-500">Request #{selectedRequest.id.split('-')[1]}</p>
            ...
            <div className="border-t pt-4">
              <h4 className="font-medium text-primary-900 mb-3">Items Requested</h4>
